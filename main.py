...
DEFAULT_ROWS['review'] = (
    ...
    "       ('test4', 1, 'Excellent', 'The best purchase I've made.'), "
...
def display_queries_page_3():
    ...
    # Query 9
    query = '''SELECT DISTINCT i.insert_user
FROM item AS i
LEFT JOIN review AS r ON i.id = r.item_id
GROUP BY i.insert_user
HAVING COUNT(r.rating_review) = 0 OR COUNT(CASE WHEN r.rating_review = 'Poor' THEN 1 END) = 0
